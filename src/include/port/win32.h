...
int			pg_setitimer(int which, const struct itimerval * value, struct itimerval * ovalue);
...
extern THREAD_LOCAL volatile int pg_signal_queue;
//extern THREAD_LOCAL int pg_signal_mask;
extern THREAD_LOCAL HANDLE pgwin32_signal_event;
extern THREAD_LOCAL HANDLE pgwin32_initial_signal_pipe;
