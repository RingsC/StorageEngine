...
NON_EXEC_STATIC THREAD_LOCAL volatile PMSignalData *PMSignalState = NULL;
...
AssignPostmasterChildSlot(void)
{
	...
	ereport(FATAL,
            ...
            errmsg("no free slots in PMChildFlags array")));
