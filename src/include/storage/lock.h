...
/* GUC variables */
extern THREAD_LOCAL int	max_locks_per_xact;

#ifdef LOCK_DEBUG
extern THREAD_LOCAL int	Trace_lock_oidmin;
extern THREAD_LOCAL bool Trace_locks;
extern THREAD_LOCAL bool Trace_userlocks;
extern THREAD_LOCAL int	Trace_lock_table;
extern THREAD_LOCAL bool Debug_deadlocks;
#endif   /* LOCK_DEBUG */
...
#define GET_VXID_FROM_PGPROC(vxid, proc) \
	((vxid).backendId = ((proc).mCurrentTransState->mTopLevelState)->vid.backendId, \
	(vxid).localTransactionId = ((proc).mCurrentTransState->mTopLevelState)->vid.localTransactionId)

#ifdef FOUNDER_XDB_SE
#define GET_VXID_FROM_XACT(vxid, xact) \
	((vxid).backendId = ((xact)->mTopLevelState)->vid.backendId, \
	(vxid).localTransactionId = ((xact)->mTopLevelState)->vid.localTransactionId)
...
extern void InitLockMethodLocalHash();
...
extern bool GetLockCheckConflict(const LOCKTAG *locktag,LOCKMODE lockmode);
