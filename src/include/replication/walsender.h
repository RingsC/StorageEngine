...
{
	pthread_t	pid;			/* this walsender's process id, or 0 */
...
extern THREAD_LOCAL WalSnd *MyWalSnd;
...
extern THREAD_LOCAL volatile sig_atomic_t walsender_shutdown_requested;
extern THREAD_LOCAL volatile sig_atomic_t walsender_ready_to_stop;
...
typedef void (*WalSenderFunc) (pthread_t, uint32, uint32, uint32, char *);
extern void report_to_receiver();
extern void SetWalSenderFunc(WalSenderFunc copyfunc, WalSenderFunc removefunc);
