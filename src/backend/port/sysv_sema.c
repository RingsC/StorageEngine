...
static THREAD_LOCAL IpcSemaphoreId *mySemaSets;		/* IDs of sema sets acquired so far */
static THREAD_LOCAL int	numSemaSets;		/* number of sema sets acquired so far */
static THREAD_LOCAL int	maxSemaSets;		/* allocated size of mySemaSets array */
static THREAD_LOCAL IpcSemaphoreKey nextSemaKey;		/* next key to try using */
static THREAD_LOCAL int	nextSemaNumber;		/* next free sem num in last sema set */
