...
extern void ScanKeyEntryInitializeWithInfo(ScanKey entry,
							   ...
							   Datum argument);
#ifdef FOUNDER_XDB_SE
extern void Fdxdb_ScanKeyInitWithCallbackInfo(ScanKey entry,
			AttrNumber attributeNumber,
			//ColuNumber columnNumber,
			StrategyNumber strategy,
			CompareCallback compareFunction,
			Datum argument);
extern void freeScanKeys(ScanKey entry,int keyNum);
