...
REDLAND_API
librdf_node* librdf_statement_get_graph(librdf_statement *statement);
REDLAND_API
int librdf_statement_get_inference_id(librdf_statement *statement);
REDLAND_API
void librdf_statement_set_inference_id(librdf_statement *statement, int inf_id);
