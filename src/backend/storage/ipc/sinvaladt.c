...
static THREAD_LOCAL SISeg *shmInvalBuffer;	/* pointer to the shared inval buffer */


static THREAD_LOCAL LocalTransactionId nextLocalTransactionId;
...
SharedInvalBackendInit(bool sendOnly)
{
	...
	MyBackendId = (BackendId)(stateP - &segP->procState[0]) + 1;
...
SICleanupQueue(bool callerHasWriteLock, int minFree)
{
	...
	if (needSig)
	{
		...
		BackendId	his_backendId = (BackendId)(needSig - &segP->procState[0]) + 1;
