...
static THREAD_LOCAL unsigned short _rand48_seed[3] = {
	RAND48_SEED_0,
	RAND48_SEED_1,
	RAND48_SEED_2
};
static THREAD_LOCAL unsigned short _rand48_mult[3] = {
	RAND48_MULT_0,
	RAND48_MULT_1,
	RAND48_MULT_2
};
static THREAD_LOCAL unsigned short _rand48_add = RAND48_ADD;
