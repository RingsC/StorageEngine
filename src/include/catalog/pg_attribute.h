...
CATALOG(pg_attribute,1249) BKI_BOOTSTRAP BKI_WITHOUT_OIDS BKI_ROWTYPE_OID(75) BKI_SCHEMA_MACRO
{
	...
	NameData	attname;		/* name of attribute. Not effectively used in FounderXDBSE. */
	 ...
	 * fail. Not effectively used in FounderXDBSE.
	 */
	Oid			atttypid;
	 ...
	 * otherwise zero. Not effectively used in FounderXDBSE.
	 */
	int4		attndims;
    ...
    // No field below is effectively used in FounderXDBSE.
	...
	/* attribute's collation. Not effectively used in FounderXDBSE. */
	Oid			attcollation;
