...
#define PG_VERSION_STR "PostgreSQL 9.1beta2, compiled by Visual C++ build " __STRINGIFY2(_MSC_VER) ", 32-bit"
...
#define VAL_CONFIGURE "--enable-thread-safety --enable-integer-datetimes --without-zlib"
