...
#define ERRCODE_NOT_IN_TRANSACTION MAKE_SQLSTATE('2','5','0','0','8')
...
/************************************************************************/
/* add new error code start                                                                    */
/************************************************************************/
/* Class J0 - libpq Error*/
#define ERRCODE_LIBPQ MAKE_SQLSTATE('J','0','0','0','0')
#define ERRCODE_SYSID_DIFF_BETWEEN_PRIMARY_AND_STANDBY MAKE_SQLSTATE('J','0','0','0','1')
#define ERRCODE_RECOVERY_TARGET_TIMELINE_DISMATCH MAKE_SQLSTATE('J','0','0','0','2')
#define ERRCODE_COPY_IO_DATA_TRANSFER_FAILURE MAKE_SQLSTATE('J','0','0','0','3')
#define ERRCODE_REPLICATION_TERMINATED_BY_PRIM_SERVER MAKE_SQLSTATE('J','0','0','0','4')
#define ERRCODE_RCV_DATA_FRM_WAL_FAILURE MAKE_SQLSTATE('J','0','0','0','5')
#define ERRCODE_SEND_DATA_TO_WAL_FAILURE MAKE_SQLSTATE('J','0','0','0','6')
#define ERRCODE_PUT_MSG_FAILURE MAKE_SQLSTATE('J','0','0','0','7')
#define ERRCODE_LIBPQ_INIT_WRONG MAKE_SQLSTATE('J','0','0','0','8')
#define ERRCODE_LIBPQZ_WAL_RECIVER_RELOAD MAKE_SQLSTATE('J','0','0','0','9')
#define ERRCODE_RECOVERY_TARGET_XLOG_HAD_REMOVED MAKE_SQLSTATE('J','0','0','1','0')
#define ERRCODE_RECOVERY_REQUEST_POINT_AHEAD_START MAKE_SQLSTATE('J','0','0','1','1')



/* Class J1 - thread Error*/
#define ERRCODE_THREAD_CREATE_FAILURE MAKE_SQLSTATE('J','1','0','0','0')

/* Class J2 - xlog Error*/
#define ERRCODE_XLOG_ERROR MAKE_SQLSTATE('J','2','0','0','0')
#define ERRCODE_XLOG_MAKE_NEW_WAL_DURING_RECOVERY MAKE_SQLSTATE('J','2','0','0','1')
#define ERRCODE_XLOG_INSTALL_SEGMENT_FILE_FAILURE MAKE_SQLSTATE('J','2','0','0','2')
#define ERRCODE_XLOG_INVALID_XLOGREAD_SOURCE MAKE_SQLSTATE('J','2','0','0','3')
#define ERRCODE_XLOG_UNKNOWN_WAL_SYNC_METHOD MAKE_SQLSTATE('J','2','0','0','4')

/* Class J3 - nbtree Error*/
#define ERRCODE_NBTREE_ERROR MAKE_SQLSTATE('J','3','0','0','0')
#define ERRCODE_NBTREE_NOT_ENOUGH_STACK_ITEM MAKE_SQLSTATE('J','3','0','0','1')

/* Class J4 - bufpage Error*/
#define ERRCODE_BUF_PAGE_ERROR MAKE_SQLSTATE('J','4','0','0','0')
#define ERRCODE_BUF_PAGE_ADD_ITEM_ERROR MAKE_SQLSTATE('J','4','0','0','1')

/* Class J5 - heap Error*/
#define ERRCODE_HEAP_ERROR MAKE_SQLSTATE('J','5','0','0','0')
#define ERRCODE_HEAP_OPEN_WITH_OID_FAILURE MAKE_SQLSTATE('J','5','0','0','1')
#define ERRCODE_HEAP_INPLACE_UPDATE_INVALID_ITEMID MAKE_SQLSTATE('J','5','0','0','2')
#define ERRCODE_HEAP_INPLACE_UPDATE_WRONG_TUPLE_LEN MAKE_SQLSTATE('J','5','0','0','3')
#define ERRCODE_HEAP_TUPLE_NO_FOUND MAKE_SQLSTATE('J','5','0','0','4')
#define ERRCODE_HEAP_INVALID_TUPLE_ATTNUM MAKE_SQLSTATE('J','5','0','0','5')

/* Class J6 - tuple Error*/
#define ERRCODE_TUPLE_ERROR MAKE_SQLSTATE('J','6','0','0','0')
#define ERRCODE_TUPLE_UNEXPECT_TAPE_END MAKE_SQLSTATE('J','6','0','0','1')
#define ERRCODE_TUPLE_UNEXPECT_DATA_END MAKE_SQLSTATE('J','6','0','0','2')
#define ERRCODE_TUPLE_BOGUS_TUPLE_LEN MAKE_SQLSTATE('J','6','0','0','3')
#define ERRCODE_TUPLE_SEEK_FAILURE MAKE_SQLSTATE('J','6','0','0','4')
#define ERRCODE_TUPLE_SEEK_EOF_FAILURE MAKE_SQLSTATE('J','6','0','0','5')
#define ERRCODE_TUPLE_SEEK_START_FAILURE MAKE_SQLSTATE('J','6','0','0','6')
#define ERRCODE_TUPLE_UPDATE_CONCURRENTLY MAKE_SQLSTATE('J','6','0','0','7')


//tuple store
#define ERRCODE_TUPLE_STORE_CALL_SET_EFLAG_LATE MAKE_SQLSTATE('J','6','1','0','0')
#define ERRCODE_TUPLE_STORE_REQUIRE_NEW_EFLAG_LATE MAKE_SQLSTATE('J','6','1','0','1')
#define ERRCODE_TUPLE_STORE_INVALID_STATE MAKE_SQLSTATE('J','6','1','0','5')
#define ERRCODE_TUPLE_STORE_WRITE_FAILURE MAKE_SQLSTATE('J','6','1','0','7')
//tuple sort
#define ERRCODE_TUPLE_SORT_INVALID_STATE MAKE_SQLSTATE('J','6','2','0','0')

/* Class J7 - hash Error*/
#define ERRCODE_HASH_ERROR MAKE_SQLSTATE('J','7','0','0','0')
#define ERRCODE_HASH_TABLE_INIT_FAILURE MAKE_SQLSTATE('J','7','0','0','1')
#define ERRCODE_HASH_UNKNOWN_ACTION_CODE MAKE_SQLSTATE('J','7','0','0','2')


/* Class J8 - time stamp Error */
#define ERRCODE_TIME_STAMP_ERROR MAKE_SQLSTATE('J','8','0','0','0')
#define ERRCODE_TIME_STAMP_INTERVAL_2_TIME_FAILURE MAKE_SQLSTATE('J','8','0','0','1')
#define ERRCODE_TIME_STAMP_UNKNOWN_INTERVAL_TYPMOD MAKE_SQLSTATE('J','8','0','0','2')

/* Class J9 - process Error */
#define ERRCODE_PROCESS_ERROR MAKE_SQLSTATE('J','9','0','0','0')
#define ERRCODE_PROCESS_ALREADY_EXIST MAKE_SQLSTATE('J','9','0','0','1')

/* Class JA - common Error */
#define ERRCODE_FUNCTION_RETURN_VALUE_WRONG MAKE_SQLSTATE('J','A','0','0','1')
#define ERRCODE_ACCESS_OBJECT_NOT_EXIST MAKE_SQLSTATE('J','A','0','0','2')

/* Class JB - lock Error */
#define ERRCODE_LOCK_ERROR MAKE_SQLSTATE('J','B','0','0','0')
#define ERRCODE_LOCK_UNKNOWN_METHOD MAKE_SQLSTATE('J','B','0','0','1')
#define ERRCODE_LOCK_UNKNOWN_MODE MAKE_SQLSTATE('J','B','0','0','2')
#define ERRCODE_LOCK_ACQUIRE_FAILURE MAKE_SQLSTATE('J','B','0','0','3')

/* Class JC - bgwriter Error */
#define ERRCODE_BGWRITER_ERROR MAKE_SQLSTATE('J','C','0','0','0')
#define ERRCODE_BGWRITER_CHECK_POINT_REQUEST_FAILURE MAKE_SQLSTATE('J','C','0','0','1')


/* Class JD - event Error */
#define ERRCODE_EVENT_ERROR MAKE_SQLSTATE('J','D','0','0','0')
#define ERRCODE_EVENT_CREATE_FAILURE MAKE_SQLSTATE('J','D','0','0','1')
#define ERRCODE_EVENT_RESET_FAILURE MAKE_SQLSTATE('J','D','0','0','2')
#define ERRCODE_EVENT_WAIT_MULTI_OBJECT_FAILURE MAKE_SQLSTATE('J','D','0','0','3')

/* Class JE - repha Error */
#define ERRCODE_REPHA_ERROR MAKE_SQLSTATE('J','E','0','0','0')
#define ERRCODE_REPHA_TWO_MASTERS MAKE_SQLSTATE('J','E','0','0','1')
#define ERRCODE_REPHA_GROUP_CREATOR_EXIST MAKE_SQLSTATE('J','E','0','0','2')

/************************************************************************/
/* add new error code end                                                                     */
/************************************************************************/
