 ...
 * update, or delete.
 */
static THREAD_LOCAL TransactionId cachedFetchXid = InvalidTransactionId;
static THREAD_LOCAL XidStatus cachedFetchXidStatus;
static THREAD_LOCAL XLogRecPtr cachedCommitLSN;
