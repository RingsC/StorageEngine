...
/* GUC parameters */
extern THREAD_LOCAL int default_statistics_target;		/* PGDLLIMPORT for
														 * PostGIS */
...
extern void vacuum_database(void);
extern void vacuum_all(void);
extern void vacuum_relations(int nrels, Oid *relids);
#endif
