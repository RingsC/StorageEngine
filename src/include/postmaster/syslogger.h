...
/* GUC options */
extern THREAD_LOCAL bool Logging_collector;
extern THREAD_LOCAL int	Log_RotationAge;
extern THREAD_LOCAL int	Log_RotationSize;
extern THREAD_LOCAL char *Log_directory;
extern THREAD_LOCAL char *Log_filename;
extern THREAD_LOCAL bool Log_truncate_on_rotation;
extern THREAD_LOCAL int	Log_file_mode;

extern THREAD_LOCAL bool am_syslogger;

#ifndef WIN32
extern THREAD_LOCAL int	syslogPipe[2];
#else
extern THREAD_LOCAL HANDLE syslogPipe[2];
#endif
