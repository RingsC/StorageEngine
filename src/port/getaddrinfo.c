...
static THREAD_LOCAL getaddrinfo_ptr_t getaddrinfo_ptr = NULL;
static THREAD_LOCAL freeaddrinfo_ptr_t freeaddrinfo_ptr = NULL;
static THREAD_LOCAL getnameinfo_ptr_t getnameinfo_ptr = NULL;
...
{
	void	   *hLibrary = NULL;
	static THREAD_LOCAL bool alreadyLookedForIpv6routines = false;
	...
	if (hLibrary != NULL)
	{
		...
		getnameinfo_ptr = (getnameinfo_ptr_t) GetProcAddress(hLibrary,
															 "getnameinfo");
#else
		getaddrinfo_ptr = (getaddrinfo_ptr_t) GetProcAddress((HMODULE)hLibrary,
															 "getaddrinfo");
		freeaddrinfo_ptr = (freeaddrinfo_ptr_t) GetProcAddress((HMODULE)hLibrary,
															 "freeaddrinfo");
		getnameinfo_ptr = (getnameinfo_ptr_t) GetProcAddress((HMODULE)hLibrary,
															 "getnameinfo");
#endif //FOUNDER_XDB_SE
