...
librdf_node*
librdf_statement_get_graph(librdf_statement *statement) 
{
  LIBRDF_ASSERT_OBJECT_POINTER_RETURN_VALUE(statement, librdf_statement, NULL);
...
/**
 * librdf_statement_set_inference_id:
 * @statement: #librdf_statement object
 * @inf_id: statement inference id
 *
 * Set the statement inference id.
 **/
void
librdf_statement_set_inference_id(librdf_statement *statement, int inf_id)
{
  LIBRDF_ASSERT_OBJECT_POINTER_RETURN(statement, librdf_statement);

  statement->inference_id = inf_id;
}

/**
 * librdf_statement_get_inference_id:
 * @statement: #librdf_statement object
 *
 * Get the inference id.
 **/
int
librdf_statement_get_inference_id(librdf_statement *statement) 
{
  LIBRDF_ASSERT_OBJECT_POINTER_RETURN_VALUE(statement, librdf_statement, NULL);

  return statement->inference_id;
}
