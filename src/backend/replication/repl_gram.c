...
#if defined(_MSC_VER)
#pragma warning ( push )
#pragma warning ( disable: 4066 4065 )
#else
...
{
       0,    94,    94,   100,   101,   105,   106,   107,   108,   115,
     125,   133,   134,   137,   142,   147,   152,   157,   168,   181,
     189,   196
};
#endif
...
{
  "$end", "error", "$undefined", "SCONST", "ICONST", "RECPTR",
...
yyreduce:
  ...
  case 18:

    {
					...
					cmd->startpos = (yyvsp[(2) - (3)].startpos);
					cmd->timeline = (yyvsp[(3) - (3)].intval);
					...
					if ((yyvsp[(2) - (2)].intval) <= 0)
						ereport(ERROR,
								(errcode(ERRCODE_SYNTAX_ERROR),
								 (errmsg("invalid timeline %d", (yyvsp[(2) - (2)].intval)))));
