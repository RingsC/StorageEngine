...
#define ACCEPT_TYPE_ARG3 unsigned int
...
/* Define to the default TCP port number on which the server listens and to
   ...
   (--with-pgport=PORTNUM) */
#define DEF_PGPORT 65432

/* Define to the default TCP port number as a string constant. */
#define DEF_PGPORT_STR "65432"
...
#define PG_VERSION_STR "PostgreSQL 9.1beta2 on i686-pc-linux-gnu, compiled by gcc (Ubuntu/Linaro 4.5.2-8ubuntu4) 4.5.2, 32-bit"
...
#define XLOG_SEG_SIZE (128 * 1024 * 1024)
