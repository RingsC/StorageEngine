...
typedef struct HeapTupleData
{
	...
	uint32 		t_nIndexes;  	/* how many indexes need to insert */
	Oid * 		t_indexOids; 	/* which indexes need to insert */
...
extern HeapTuple heap_form_tuple(TupleDesc tupleDescriptor,
				Datum *values, bool *isnull, uint32 nEids = 0, Oid *pEids = NULL);
...
extern void *minimal_tuple_getdata(MinimalTuple mtup,int &len);
