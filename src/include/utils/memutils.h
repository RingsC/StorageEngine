...
extern THREAD_LOCAL MemoryContext PostmasterContext;
extern THREAD_LOCAL MemoryContext CacheMemoryContext;
...
extern THREAD_LOCAL MemoryContext PortalContext;
 ...
 */
extern void MemoryContextInit(bool thread);
extern void MemoryContextReset(MemoryContext context, bool useLock);
...
#if defined(ALLOC_INFO) 
extern void MemoryContextStats(MemoryContext context, bool memleak=false, int depth=5, size_t size = 1024*1024);
#else
...
#ifdef FOUNDER_XDB_SE
extern void fxdb_free_topmemory(int code, Datum arg);
#endif //FOUNDER_XDB_SE
