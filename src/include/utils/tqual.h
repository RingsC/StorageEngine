...
extern THREAD_LOCAL SnapshotData SnapshotNowData;
extern THREAD_LOCAL SnapshotData SnapshotSelfData;
extern THREAD_LOCAL SnapshotData SnapshotAnyData;
extern THREAD_LOCAL SnapshotData SnapshotToastData;
extern THREAD_LOCAL SnapshotData SnapshotDirtyData;

#define SnapshotNow			(&SnapshotNowData)
#define SnapshotSelf		(&SnapshotSelfData)
#define SnapshotAny			(&SnapshotAnyData)
#define SnapshotToast		(&SnapshotToastData)
#define SnapshotDirtyPtr		(&SnapshotDirtyData) // avoid name clashes. used by public interface impl.
