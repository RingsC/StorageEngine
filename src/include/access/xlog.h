...
extern THREAD_LOCAL int	sync_method;
#endif //FOUNDER_XDB_SE
...
#ifdef FOUNDER_XDB_SE
extern THREAD_LOCAL TimeLineID ThisTimeLineID;	/* current TLI */
#endif //FOUNDER_XDB_SE
 ...
 */
extern THREAD_LOCAL bool InRecovery;
...
extern THREAD_LOCAL HotStandbyState standbyState;
...
extern THREAD_LOCAL XLogRecPtr XactLastRecEnd;

/* these variables are GUC parameters related to XLOG */
extern int	CheckPointSegments;
extern int	wal_keep_segments;
#ifdef FOUNDER_XDB_SE
extern bool wal_force_send_before_removed;
#endif
...
#ifdef FOUNDER_XDB_SE
extern THREAD_LOCAL int	XLOGbuffers;
extern THREAD_LOCAL int	XLogArchiveTimeout;
extern bool XLogArchiveMode;
#endif //FOUNDER_XDB_SE
...
#ifdef FOUNDER_XDB_SE
extern THREAD_LOCAL bool XLOG_DEBUG;
#endif //FOUNDER_XDB_SE
...
extern THREAD_LOCAL CheckpointStatsData CheckpointStats;
...
#ifdef FOUNDER_XDB_SE
extern void fxdb_close_xlogfile(int code, Datum arg);
#endif //FOUNDER_XDB_SE
...
extern void SetControlFileNodeId(uint32 nodeId);
extern uint32 GetControlFileNodeId(void);
int XLogArchiveOrRestoreFile(const char *filename, char *path, bool archive);
