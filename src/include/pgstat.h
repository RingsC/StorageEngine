 ...
 */
extern THREAD_LOCAL PgStat_MsgBgWriter BgWriterStats;
...
extern void pgstat_report_vacuum(Oid tableoid, Oid dbid, bool shared,
...
extern const char *pgstat_get_backend_current_activity(pthread_t pid, bool checkUser);
