 ...
 * ----------
 */
static THREAD_LOCAL PGLZ_HistEntry *hist_start[PGLZ_HISTORY_LISTS];
static THREAD_LOCAL PGLZ_HistEntry hist_entries[PGLZ_HISTORY_SIZE];
...
pglz_decompress(const PGLZ_Header *source, char *dest)
{
	...
	if (dp != destend || sp != srcend)
		ereport(ERROR,
                ...
                errmsg("compressed data is corrupt")));
