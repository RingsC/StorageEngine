...
static THREAD_LOCAL PGShmemHeader *ShmemSegHdr;		/* shared mem segment header */

static THREAD_LOCAL void *ShmemBase;			/* start address of shared memory */

static THREAD_LOCAL void *ShmemEnd;			/* end+1 address of shared memory */

slock_t    *ShmemLock;			/* spinlock for shared memory and LWLock
																				* allocation */

static THREAD_LOCAL HTAB *ShmemIndex = NULL; /* primary index hashtable for shmem */
#endif //FOUNDER_XDB_SE
