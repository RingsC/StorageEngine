...
/* Hash table to lookup combo cids by cmin and cmax */
#define comboHash (CurrentTransactionState->mTopLevelState->mComboHash)
#endif //FOUNDER_XDB_SE
...
* To convert a combo cid to cmin and cmax, you do a simple array lookup.
*/
//static THREAD_LOCAL ComboCidKey comboCids = NULL;
//static THREAD_LOCAL int	usedComboCids = 0;	/* number of elements in comboCids */
//static THREAD_LOCAL int	sizeComboCids = 0;	/* allocated size of array */

#define comboCids (CurrentTransactionState->mTopLevelState->mComboCids)
#define usedComboCids (CurrentTransactionState->mTopLevelState->nUsedComboCids)
#define sizeComboCids (CurrentTransactionState->mTopLevelState->nSizeComboCids)
#endif //FOUNDER_XDB_SE
...
{
	Assert(combocid < (CommandId)usedComboCids);
