...
extern Relation index_open(Oid relationId, LOCKMODE lockmode,Oid dbid = MyDatabaseId);
#else
extern Relation index_open(Oid relationId, LOCKMODE lockmode, Oid tableSpace, IndexType indextype);
#endif //FOUNDER_XDB_SE
extern void index_close(Relation relation, LOCKMODE lockmode);
extern Datum *combineIndexKeys(Relation heap, Relation index, HeapTuple tup, size_t *nkeys);
...
extern void IndexScanEnd(IndexScanDesc scan, bool freeScankey, bool freeOrderByData);
#ifndef FOUNDER_XDB_SE
