...
#ifdef FOUNDER_XDB_SE
void
static estimate_rel_size(Relation rel, int32 *attr_widths,
		...
		case RELKIND_TOASTVALUE:
			...
			*pages = curpages;
			...
			else
			{
				 ...
				 */
				int32		tuple_width = 0;
				Assert(0 != rel->rd_colinfo->tuple_size);
				tuple_width += (uint32)(rel->rd_colinfo->tuple_size);
				tuple_width += sizeof(HeapTupleHeaderData);
				tuple_width += sizeof(ItemPointerData);
				/* note: integer division is intentional here */
				density = (BLCKSZ - SizeOfPageHeaderData) / tuple_width * 1.0;
			}
