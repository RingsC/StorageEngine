...
extern Tuplesortstate *tuplesort_begin_datum(Oid datumType,
					  ...
					  int workMem, bool randomAccess);
#else
extern Tuplesortstate *tuplesort_begin_data(int workMem, 
																						bool randomAccess, 
																						void *compare_func);
#endif //FOUNDER_XDB_SE
...
extern void tuplesort_putdatum(Tuplesortstate *state, Datum val,
				   bool isNull);
#else
extern void tuplesort_putdata(Tuplesortstate *state, void *val, size_t len);
#endif //FOUNDER_XDB_SE

extern void tuplesort_performsort(Tuplesortstate *state, void *compare_func = 0);
#ifndef FOUNDER_XDB_SE
...
#else
extern bool tuplesort_getdata(Tuplesortstate *state, bool forward,
												 void **pData, int *len);
#endif //FOUNDER_XDB_SE
...
extern bool tuplesort_support_random_access(Tuplesortstate *state);
extern void tuplesort_set_sorted(Tuplesortstate *state);
extern Tuplesortstate* tuplesort_begin_index_datum(int workMem, bool randomAccess, Relation indexRel);
extern void tuplesort_putdatum(Tuplesortstate *state, Datum val, ItemPointer tid);
extern bool tuplesort_getdatum(Tuplesortstate *state, bool forward, Datum *val, ItemPointer tid);
extern bool tuplesort_getdatum1(Tuplesortstate *state, bool forward, Datum *val, void **privateData);
