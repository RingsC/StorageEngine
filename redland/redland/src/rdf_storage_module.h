...
struct librdf_storage_factory_s {
  ...
  librdf_query_results* (*query_execute)(librdf_storage* storage, librdf_query *query);
	...
	/** Drop a storage */
	int (*drop_storage)(librdf_storage *storage);

	/** Set prepare to multi insert */
	void (*set_multi_insert_prepare)(librdf_storage *storage);

	/** Set execute multi insert */
	void (*set_multi_insert_execute)(librdf_storage *storage);

	/** Counter remove results */
	unsigned int (*counter_remove_rows)(librdf_storage *storage);
