...
struct librdf_parser_factory_s
{
  ...
  #else
  int (*parse_file_handle_into_model)(void *_context, FILE *fh, FILE *close_fh, librdf_uri* base_uri, librdf_model *model);
  librdf_stream* (*parse_file_handle_as_stream)(void *_context, FILE *fh, FILE *close_fh, librdf_uri *base_uri);  
  #endif
};
