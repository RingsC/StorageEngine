...
#include "raptor2.h"
#define RAPTOR_MALLOC(type, size) MEMCONTEXT_MALLOC(type, size)
#define RAPTOR_CALLOC(type, nmemb, size) MEMCONTEXT_CALLOC(type, nmemb, size)
#define RAPTOR_REALLOC(type, ptr, size) MEMCONTEXT_REALLOC(type, ptr, size)
#define RAPTOR_FREE(type, ptr)   MEMCONTEXT_FREE(type, ptr)
#endif
...
#else
#define RAPTOR_READ_BUFFER_SIZE 4096*1024
#endif
...
#define RAPTOR_WWW_BUFFER_SIZE 1024*1024
#endif
