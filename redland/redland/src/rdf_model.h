...
REDLAND_API 
librdf_list* librdf_model_get_all_graph(librdf_world *world);
REDLAND_API 
int librdf_drop_model (librdf_model* model);
REDLAND_API
int librdf_model_remove_statement_any(librdf_model* model, librdf_statement* statement);
REDLAND_API
unsigned int librdf_model_counter_remove_rows(librdf_model* model);
