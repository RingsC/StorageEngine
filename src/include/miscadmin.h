...
extern THREAD_LOCAL volatile bool InterruptPending;
extern THREAD_LOCAL volatile bool QueryCancelPending;
extern THREAD_LOCAL volatile bool ProcDiePending;

/* these are marked volatile because they are examined by signal handlers: */
extern THREAD_LOCAL volatile bool ImmediateInterruptOK;
extern THREAD_LOCAL volatile uint32 InterruptHoldoffCount;
extern THREAD_LOCAL volatile uint32 CritSectionCount;

/* in tcop/postgres.c */
extern void ProcessInterrupts(void);

extern void pg_process_signals( void );
#ifndef WIN32
 ...
 */
extern  pthread_t PostmasterPid;
extern THREAD_LOCAL bool IsPostmasterEnvironment;
extern THREAD_LOCAL bool IsUnderPostmaster;
extern THREAD_LOCAL bool IsBinaryUpgrade;
...
extern THREAD_LOCAL pthread_t	MyProcPid;
extern THREAD_LOCAL pg_time_t MyStartTime;
extern THREAD_LOCAL struct Port *MyProcPort;
extern THREAD_LOCAL long MyCancelKey;
extern THREAD_LOCAL int	MyPMChildSlot;

#ifndef FOUNDER_XDB_SE
extern THREAD_LOCAL char OutputFileName[];
extern THREAD_LOCAL char my_exec_path[];
extern THREAD_LOCAL char pkglib_path[];
#endif //FOUNDER_XDB_SE

#ifdef EXEC_BACKEND
extern THREAD_LOCAL char postgres_exec_path[];
#endif

/*
 * done in storage/backendid.h for now.
 *
 * extern THREAD_LOCAL BackendId    MyBackendId;
 */
...
extern THREAD_LOCAL int	DateStyle;
extern THREAD_LOCAL int	DateOrder;
...
extern THREAD_LOCAL int	IntervalStyle;
 ...
 */
extern THREAD_LOCAL bool HasCTZSet;
extern THREAD_LOCAL int	CTimeZone;

#define MAXTZLEN		10		/* max TZ name len, not counting tr. null */

extern  bool enableFsync;
extern THREAD_LOCAL bool allowSystemTableMods;
extern  int work_mem;
extern  int bitmap_mem;
extern  int maintenance_work_mem;

extern THREAD_LOCAL int	VacuumCostPageHit;
extern THREAD_LOCAL int	VacuumCostPageMiss;
extern THREAD_LOCAL int	VacuumCostPageDirty;
extern THREAD_LOCAL int	VacuumCostLimit;
extern THREAD_LOCAL int	VacuumCostDelay;

extern THREAD_LOCAL int	VacuumCostBalance;
extern THREAD_LOCAL bool VacuumCostActive;
...
/* in utils/misc/guc.c */
extern THREAD_LOCAL int	trace_recovery_messages;
...
extern THREAD_LOCAL bool process_shared_preload_libraries_in_progress;
extern THREAD_LOCAL char *shared_preload_libraries_string;
extern THREAD_LOCAL char *local_preload_libraries_string;
