...
#endif //FOUNDER_XDB_SE
extern THREAD_LOCAL const char *debug_query_string;
extern THREAD_LOCAL int	max_stack_depth;
extern THREAD_LOCAL int	PostAuthDelay;
...
extern THREAD_LOCAL int	log_statement;
